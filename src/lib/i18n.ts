...
export const translations = {
  ar: {
    ...
    home: {
      ...
      subtitle:
        "RapidKeyz | متجر الاشتراكات الرقمية والذكاء الاصطناعي، بالجنيه المصري، تسليم خلال دقائق، ودعم فني 24/7 عبر واتساب.",
    ...
    footer: {
      tagline: "المتجر العربي الأول للاشتراكات الرقمية  وأدوات الـ Ai بأسعار مصرية.",
  ...
  en: {
    ...
    home: {
      ...
      trusted: "Trusted by 5,000+ professionals & agencies",
      viewAll: "View all",
    },
