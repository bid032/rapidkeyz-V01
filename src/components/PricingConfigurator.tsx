      ...
      <AnimatePresence>
        {open && (
          <motion.ul
            ...
            className="absolute z-30 mt-2 w-full max-h-72 overflow-auto rounded-2xl border border-white/10 bg-card/70 backdrop-blur-2xl backdrop-saturate-150 shadow-2xl p-1.5"
