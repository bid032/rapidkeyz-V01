  ...
  head: () => ({
    meta: [
      { title: "RapidKeyz | متجر الاشتراكات الرقمية والذكاء الاصطناعي." },
      {
        name: "description",
        content:
          "RapidKeyz | متجر الاشتراكات الرقمية والذكاء الاصطناعي، بأسعار مصرية وتسليم فوري خلال دقائق. ضمان 100% ودعم 24/7.",
      },
      ...
      { property: "og:title", content: "RapidKeyz | متجر الاشتراكات الرقمية والذكاء الاصطناعي." },
      {
        ...
        content: "RapidKeyz | متجر الاشتراكات الرقمية والذكاء الاصطناعي، بأسعار مصرية وتسليم فوري خلال دقائق. ضمان 100% ودعم 24/7.",
      },
